...
if __name__ == '__main__':
    ...
    with app.app_context():
        ...
        admin = NguoiDung(ho_ten='Admin Hệ Thống', ten_nd='admin', mat_khau=pwd,email='admin@hisport.com', so_dien_thoai='03245124251', vai_tro=VaiTro.QUAN_LY)
        user1 = NguoiDung(ho_ten='Nguyễn Công Phượng', ten_nd='user1', mat_khau=pwd,so_dien_thoai = '0373548687',email = 'phuong012@gmail.com', vai_tro=VaiTro.NHAN_VIEN)
        user2 = NguoiDung(ho_ten='Lý Hoàng Nam', ten_nd='user2', mat_khau=pwd,so_dien_thoai = '0373548688',email = 'namnam03@gmail.com', vai_tro=VaiTro.NGUOI_DUNG)
        user3 = NguoiDung(ho_ten='Đặng Nhật Nam', ten_nd='user3', mat_khau=pwd, so_dien_thoai='0777785301',email='dangnem03@gmail.com', vai_tro=VaiTro.NGUOI_DUNG)
